...
<html lang="en">
   ...
   <div class="hnc-static-image-container">
      <!-- <img src="img/chinh_sach_van_chuyen.jpg" class="hnc-static-image loaded" alt="bảo hành ECCO" data-was-processed="true"> -->
    
      <img src="img/banner-ship.png" class="hnc-static-image loading" alt="ECCO giao hàng toàn quốc" data-was-processed="true">
    </div>
   ...
   <p class="hnc-static-text hnc-notice-text">Ghi chú: (*) Giao hàng nhanh 2h áp dụng cho những sản phẩm còn hàng trong kho của AWEB trong cùng tỉnh thành với điểm nhận hàng của Khách hàng. (*) Giao hàng nhanh 2h áp dụng trong bán kính 20km từ các showroom bán hàng của ECCO (*) Giao hàng nhanh 2h áp dụng cho các đơn hàng lẻ (sản phẩm có kích thước nhỏ gọn, các sản phẩm không yêu cầu lắp ráp, cài đặt trước khi giao,…)</p>
   </div>   
  </div>  
</div>
