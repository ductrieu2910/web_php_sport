                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                Thêm mới hình thức thánh toán
                            </div>
                            <div class="card-body">
                                <form method="POST" action="thanh_toan_them_moi_thuc_hien.php" enctype="multipart/form-data">
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="txtHinhThucTT" name="txtHinhThucTT" placeholder="Hình thức thanh toán" />
                                        <label for="txtHinhThucTT">Hình thức thanh toán</label>
                                     </div>
                                    <div class="form-floating mb-3">
                                        <textarea class="form-control" id="txtGhiChuTT" name="txtGhiChuTT" placeholder="Ghi chú"></textarea>
                                        <label for="txtGhiChuTT">Ghi chú</label>
                                    </div>
                                    <div class="mt-4 mb-0">
                                        <div class="d-grid"><button type="submit" class="btn btn-primary btn-block">Thêm hình thức thanh toán</button></div>
                                    </div>
                                </form>
                            </div>
                        </div>
