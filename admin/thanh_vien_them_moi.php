                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item"><a href="quan_tri_thanh_vien.php">Quản trị thành viên</a></li>
                        </ol>
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form method="POST" action="thanh_vien_them_moi_thuc_hien.php" enctype="multipart/form-data">
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="txtHoTen" name="txtHoTen" placeholder="Họ tên thành viên" />
                                        <label for="txtHoTen">Họ tên thành viên</label>
                                     </div>
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="txtTenDangNhap" name="txtTenDangNhap" placeholder="Tên đăng nhập" />
                                    ...
                                    <div class="mt-4 mb-0">
                                        <div class="d-grid"><button type="submit" class="btn btn-primary btn-block">THÊM THÀNH VIÊN</button></div>
                                    </div>
                                </form>
                            </div>
                        </div>
