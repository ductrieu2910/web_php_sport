                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active">Quản trị cửa hàng</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-header">
                                <i class="fas fa-table me-1"></i>
                                Danh sách cửa hàng | <a href="cua_hang_them_moi.php"><button type="submit" class="btn btn-primary btn-block">Thêm mới cửa hàng</button></a> 
                            </div>
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="text-align: center;">Tên cửa hàng</th>
                   ...
                   $sql = "
                    ...
                    $i = 0;
                    while ($row = mysqli_fetch_array($noi_dung_cua_hang)) 
                    {
                        $i++
                    ;?>
                    ...
                    <tr>
                        ...
                        <td><?php echo $row['dia_chi_cua_hang'] ;?></td>
                        <td><?php echo $row['email_cua_hang'] ;?></td>
                        <td style="text-align: center;"><?php echo $row['hotline_cua_hang'] ;?></td>
                        <td style="text-align: center;"><a href="cua_hang_sua.php?id=<?php echo $row['ma_cua_hang'] ;?>"><button type="submit" class="btn btn-primary btn-block">Sửa</button></a></td>
                        <td style="text-align: center;"><a href="cua_hang_xoa.php?id=<?php echo $row['ma_cua_hang'] ;?>"><button type="submit" class="btn btn-primary btn-block">Xóa</button></a></td>
                    </tr>
                    <?php
                    }
