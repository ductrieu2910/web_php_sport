...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        ...
        if ($anh_minh_hoa == NULL) {
          $sql = "
               UPDATE `sanpham` 
               SET `tensanpham` = '".$tensanpham."', `manhomsp` = '".$manhomsp."', `maloaisp` = '".$maloaisp."', `soluong` = '".$soluong."', `gia` = '".$gia."', `noidung` = '".$noidung."', `khuyenmai` = '".$khuyen_mai."', `gia_sau_giam` = '".$giasaugiam."', `motasp` = '".$mota_sp."' 
          ...
          $sql = "
               UPDATE `sanpham` 
               SET `tensanpham` = '".$tensanpham."', `manhomsp` = '".$manhomsp."', `maloaisp` = '".$maloaisp."', `soluong` = '".$soluong."', `gia` = '".$gia."', `noidung` = '".$noidung."', `khuyenmai` = '".$khuyen_mai."', `gia_sau_giam` = '".$giasaugiam."', `motasp` = '".$mota_sp."', `anhdaidien` = '".$anh_minh_hoa."' 
               WHERE `sanpham`.`sp_id` = '".$san_pham_id."'
           ";
        }
