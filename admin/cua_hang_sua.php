                            ...
                            <div class="card-body">
                              ...
                              <?php
                                ...
                                $sql = "
                                        SELECT *  
                                        FROM cua_hang 
                                        WHERE ma_cua_hang = ".$cua_hang_id."
                                        ORDER BY ma_cua_hang ASC";

                                // 3. Thực thi câu lệnh truy vấn (mục đích trả về dữ liệu các bạn cần)
                                $noi_dung_cua_hang = mysqli_query($ket_noi, $sql);

                                // 4. Hiển thị ra dữ liệu bạn vừa lấy được
                                $row = mysqli_fetch_array($noi_dung_cua_hang);
                    
                              ;?> 
                                <form method="POST" action="cua_hang_sua_thuc_hien.php" enctype="multipart/form-data">
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="txtTenCuaHang" name="txtTenCuaHang" placeholder="Tên của hàng" value="<?php echo $row['ten_cua_hang'] ;?>" />
                                        <label for="txtTenCuaHang">Tên cửa hàng</label>
                                     </div>
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="txtDiaChiCuaHang" name="txtDiaChiCuaHang" placeholder="Địa chỉ cửa hàng" value="<?php echo $row['dia_chi_cua_hang'] ;?>" />
                                        <label for="txtDiaChiCuaHang">Địa chỉ cửa hàng</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="txtEmailCuaHang" name="txtEmailCuaHang" placeholder="Email cửa hàng" value="<?php echo $row['email_cua_hang'] ;?>" />
                                        <label for="txtEmailCuaHang">Email cửa hàng</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <textarea class="form-control" id="txtLinkBanDo" name="txtLinkBanDo" placeholder="Link bản đổ"><?php echo $row['ban_do'];?></textarea>
                                        <label for="txtLinkBanDo">Link bản đồ</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="txtLinkFacebook" name="txtLinkFacebook" placeholder="Link facebook" value="<?php echo $row['link_facebook'] ;?>" />
                                        <label for="txtLinkFacebook">Link facebook</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="txtLinkInternet" name="txtLinkInternet" placeholder="Link internet" value="<?php echo $row['link_internet'] ;?>"/>
                                        <label for="txtLinkInternet">Link internet</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="txtLinkYoutube" name="txtLinkYoutube" placeholder="Link youtube" value="<?php echo $row['link_youtube'] ;?>"/>
                                        <label for="txtLinkYoutube">Link youtube</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="txtHotlineCuaHang" name="txtHotlineCuaHang" placeholder="Hotline cửa hàng" value="<?php echo $row['hotline_cua_hang'] ;?>" />
                                        <label for="txtHotlineCuaHang">Hotline cửa hàng</label>
                                    </div>
                                    <div class="mt-4 mb-0">
                                        <input type="hidden" name="txtIDCH" value="<?php echo $row['ma_cua_hang'] ;?>">
                                        <div class="d-grid"><button type="submit" class="btn btn-primary btn-block">SỬA CỬA HÀNG</button></div>
                                    </div>
                                </form>
                            </div>
                        </div>
