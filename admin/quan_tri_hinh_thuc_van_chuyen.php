...
<html lang="en">
    <head>
        ...
        <title>Quản trị hình thức vận chuyển</title>
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active">Quản trị hình thức vận chuyển</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-header">
                                <i class="fas fa-table me-1"></i>
                                Danh sách hình thức vận chuyển | <a href="van_chuyen_them_moi.php"><button type="submit" class="btn btn-primary btn-block">Thêm mới hình thức vận chuyển</button></a> 
                            </div>
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="text-align: center;">Giá cước (VNĐ)</th>
                   ...
                   $sql = "
                    ...
                    $i = 0;
                    while ($row = mysqli_fetch_array($noi_dung_van_chuyen)) 
                    {
                        $i++
                    ;?>
                    ...
                    <tr>
                        ...
                        <td><?php echo $row['hinhthucvc'] ;?></td>
                        <td style="text-align: center;"><?php echo $row['giacuoc'] ;?></td>
                        <td style="text-align: center;"><a href="van_chuyen_sua.php?id=<?php echo $row['mavanchuyen'] ;?>"><button type="submit" class="btn btn-primary btn-block">Sửa</button></a></td>
                        <td style="text-align: center;"><a href="van_chuyen_xoa.php?id=<?php echo $row['mavanchuyen'] ;?>"><button type="submit" class="btn btn-primary btn-block">Xóa</button></a></td>
                    </tr>
                    <?php
                    }
