            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                Danh sách thành viên | <a href="thanh_vien_them_moi.php"><button type="submit" class="btn btn-primary btn-block">Thêm mới thành viên</button></a>
                            </div>
                            <div class="card-body">
                   ...
                   $sql = "
                    ...
                    $i = 0;
                    while ($row = mysqli_fetch_array($noi_dung_thanh_vien)) 
                    {
                        $i++
                    ;?>
                    ...
                    <tr>
                        <td style="text-align: center;"><?php echo $i ;?></td>
                            ...
                            <td style="text-align: center;"><?php echo $row['ngaytao'] ;?></td>
                            <td style="text-align: center;"><a href="thanh_vien_xoa.php?id=<?php echo $row['mathanhvien'] ;?>"><button type="submit" class="btn btn-primary btn-block">Xóa</button></a></td>
                    </tr>
