                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                Danh sách sản phẩm | <a href="san_pham_them_moi.php"><button type="submit" class="btn btn-primary btn-block">Thêm mới sản phẩm</button></a>
                            </div>
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="text-align: center;">Giá sau giảm (VND)</th>
                   ...
                   $sql = "
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;"><?php echo $row['manhomsp'] ;?></td>
                        <td style="text-align: center;"><?php echo $row['maloaisp'] ;?></td>
                        <td><?php echo $row['noidung'] ;?></td>
                        <td style="text-align: center;"><?php echo $row['gia'] ;?></td>
                        <td style="text-align: center;"><?php echo $row['khuyenmai'] ;?></td>
                        <td style="text-align: center;"><?php echo $row['gia_sau_giam'] ;?></td>
                        ...
                        <td style="text-align: center;"><a href="san_pham_sua.php?id=<?php echo $row['sp_id'] ;?>"><button type="submit" class="btn btn-primary btn-block">Sửa</button></a></td>
                        <td style="text-align: center;"><a href="san_pham_xoa.php?id=<?php echo $row['sp_id'] ;?>"><button type="submit" class="btn btn-primary btn-block">Xóa</button></a></td>
                    </tr>
