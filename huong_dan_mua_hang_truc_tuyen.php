...
<html lang="en">
    ...
    <h1 class="hnc-static-heading1">HƯỚNG DẪN MUA HÀNG TRỰC TUYẾN TẠI ECCO</h1>
    ...
    <div class="hnc-static-dash"></div>
    <p class="hnc-static-step">CÁCH 2: ĐẶT HÀNG QUA HỆ THỐNG WEBSITE CỦA ECCO</p>
    <h3 .hnc-static-heading3>BƯỚC 1: TÌM SẢN PHẨM CẦN MUA</h3>
    <p class="hnc-static-text">Bạn có thể truy cập website ecco để tìm và chọn sản phẩm muốn mua bằng nhiều cách:</p>
